...
from . import crossref, europe_pmc, exa, github, ietf, nvd, openalex, perplexity_deep, pypi, scholar, sonar
...
ADAPTERS = {
    ...
    "crossref-works-search@v1": {"build": crossref.build, "parse": crossref.parse},
